    ...
    <section className="bg-muted/30 py-20">
      <div className="container mx-auto">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">이력서 역량 목록의 반복 대신, 프로젝트에서 검증 가능한 작업 기준 3개로 압축</p>
        </div>
            ...
            return (
              <Card key={highlight.title} className="border-0 shadow-sm">
                ...
                <CardContent className="space-y-5">
                  <p className="text-sm leading-relaxed text-muted-foreground">{highlight.summary}</p>
